...
# FULL MODE (synth)
# =========================
DEFAULT_FULL_INPUT_CSV = BASE_DIR / "data" / "enriched" / "idiomx_synth_enriched_final_ready_v1.csv"
DEFAULT_FULL_OUTPUT_VALIDATED_CSV = BASE_DIR / "data" / "enriched" / "idiomx_synth_enriched_final_validated_v1.csv"
DEFAULT_FULL_OUTPUT_ISSUES_CSV = BASE_DIR / "data" / "enriched" / "idiomx_synth_enriched_final_issues_v1.csv"

# =========================
# SAMPLE MODE (synth)
# =========================
DEFAULT_SAMPLE_INPUT_CSV = BASE_DIR / "data" / "sample" / "idiomx_synth_enriched_final_ready_sample_v1.csv"
DEFAULT_SAMPLE_OUTPUT_VALIDATED_CSV = BASE_DIR / "data" / "sample" / "idiomx_synth_enriched_final_validated_sample_v1.csv"
DEFAULT_SAMPLE_OUTPUT_ISSUES_CSV = BASE_DIR / "data" / "sample" / "idiomx_synth_enriched_final_issues_sample_v1.csv"
...
def validate_dataset(
    ...
    for i, row in df.iterrows():
        ...
        # Main examples
            ...
            elif str(is_example_idiom).strip() == "":
            ...
            elif str(minimal_pair_id).strip() == "":
...
def parse_args():
    parser = argparse.ArgumentParser(description="Validate synthetic IdiomX enriched dataset.")
...
if __name__ == "__main__":
    ...
    validate_dataset(
        input_file=Path(args.input_csv) if args.input_csv else None,
