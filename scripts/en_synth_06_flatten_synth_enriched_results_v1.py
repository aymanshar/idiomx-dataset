...
DEFAULT_INPUT_JSON = BASE_DIR / "data" / "results" / "idiomx_synth_enriched_full_v1.json"
DEFAULT_OUTPUT_CSV = BASE_DIR / "data" / "enriched" / "idiomx_synth_enriched_full_v1.csv"
        ...
        for ex in examples:
            rows.append({
                **base,
                ...
                # LLM output uses "example" -> final dataset uses "idiom_in_example"
                "idiom_in_example": ex.get("example", ""),
...
def parse_args():
    parser = argparse.ArgumentParser(description="Flatten parsed synthetic enrichment results.")
