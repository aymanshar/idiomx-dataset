...
DEFAULT_FULL_INPUT_CSV = BASE_DIR / "data" / "enriched" / "idiomx_modern_enriched_full_v1.csv"
DEFAULT_FULL_OUTPUT_VALIDATED_CSV = BASE_DIR / "data" / "enriched" / "idiomx_modern_enriched_full_validated_v1.csv"
DEFAULT_FULL_OUTPUT_ISSUES_CSV = BASE_DIR / "data" / "enriched" / "idiomx_modern_enriched_full_issues_v1.csv"
